...
define('STATSFC_TOPSCORERS_ID',		'StatsFC_Top_Scorers');
...
class StatsFC_TopScorers extends WP_Widget {
	...
	public function widget($args, $instance) {
		...
		$data = file_get_contents('https://api.statsfc.com/premier-league/top-scorers.json?key=' . $api_key);
		...
		try {
			...
			if ($default_css) {
				wp_register_style(STATSFC_TOPSCORERS_ID . '-css', plugins_url('c/all.css', __FILE__));
